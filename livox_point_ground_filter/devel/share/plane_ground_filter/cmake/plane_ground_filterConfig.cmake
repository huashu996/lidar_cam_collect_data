...
if("TRUE" STREQUAL "TRUE")
  set(plane_ground_filter_SOURCE_PREFIX /home/b/cxl/livox_point_process/src/plane_fit_ground_filter/plane_ground_filter)
  set(plane_ground_filter_DEVEL_PREFIX /home/b/cxl/livox_point_process/devel)
  ...
  set(plane_ground_filter_INSTALL_PREFIX /home/b/cxl/livox_point_process/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plane_ground_filter' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/b/cxl/livox_point_process/src/plane_fit_ground_filter/plane_ground_filter/${idir}'.  ${_report}")
    endif()
...
set(plane_ground_filter_EXPORTED_TARGETS "")
